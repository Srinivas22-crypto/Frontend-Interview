...
"[project]/src/app/api/blogs/[id]/like/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request, { params }) {
    ...
    if (isLiked) {
        // Unlike
        const updatedBlog = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$blogs$2f$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["blogStore"].update(blogId, {
            likes: blog.likes - 1,
            likedBy: blog.likedBy.filter((id)=>id !== userId)
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(updatedBlog);
    } else {
        // Like
        const updatedBlog = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$blogs$2f$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["blogStore"].update(blogId, {
            likes: blog.likes + 1,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6d2fb0f8._.js.map